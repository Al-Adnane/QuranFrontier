...
class NahuatlTheaterNetwork(nn.Module):
    ...
    def self_test(cls) -> bool:
        ...
        model = cls(vocab_size=100, embed_dim=64, hidden_dim=128, num_roles=4)
        model.eval()
        ...
        assert result['moral_result']['moral_coherence'].shape == (2, 1)
        print("NahuatlTheaterNetwork self_test PASSED")
        return True
