 ...
 *
 * Unified API for all 37+ frontier capabilities:
 ...
 * - rPPG Detection, GAN Fingerprinting, Diffusion Detection, Image Forensics, Steganography
 *
 * @module frontier-api
 * @version 3.6.0
 */
...
import * as quantumML from '@/lib/frontier/quantum-ml';
import * as predictiveIntelligence from '@/lib/frontier/predictive-intelligence';
import * as selfSupervisedDetection from '@/lib/frontier/self-supervised-detection';

// v3.6.0 Forensic Analysis (NEW)
import * as rppgDetection from '@/lib/frontier/rppg-detection';
import * as ganFingerprinting from '@/lib/frontier/gan-fingerprinting';
import * as diffusionDetection from '@/lib/frontier/diffusion-detection';
import * as imageForensics from '@/lib/frontier/image-forensics';
import * as steganographyDetection from '@/lib/frontier/steganography-detection';
